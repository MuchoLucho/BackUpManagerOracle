public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            jTable2.getColumnModel().getColumn(0).setHeaderValue("Strategy");
            jTable2.getColumnModel().getColumn(1).setHeaderValue("Database");
            jTable2.getColumnModel().getColumn(2).setHeaderValue("Date");
            jTable2.getColumnModel().getColumn(3).setHeaderValue("Hour");
            jTable2.getColumnModel().getColumn(4).setHeaderValue("Success");
        }
