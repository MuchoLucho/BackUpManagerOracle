...
public class FrontEnd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Name of Strategy");
        ...
        jToggleButton1.setText("Sunday");

        jToggleButton2.setText("Monday");

        jToggleButton3.setText("Tuesday");

        jToggleButton4.setText("Wednesday");

        jToggleButton5.setText("Saturday");

        jToggleButton6.setText("Friday");

        jToggleButton7.setText("Thursday");
        ...
        time_group.add(jRadioButton3);
        jRadioButton3.setText("Interval");

        time_group.add(jRadioButton4);
        jRadioButton4.setText("Specific");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Minutes", "Hours" }));

        jLabel1.setText("Execute Every");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 872, javax.swing.GroupLayout.PREFERRED_SIZE))
